<div id="new-experience-modal" class="dn bg-black-60 pa br w100 h100 p20 --modal-overlay">
	<div class="pr --modal-content w-max-med center bg-white bsh br5 mb20">
		<div class="--modal-close fr fs22 fw6 c-dark-gray mr10 p10 cp" data-modal="new-experience">x</div>
		<div class="clear"></div>
		<h3 class="tc">Experience</h2>
		<form action="<?=HOME?>experience/create" method="post">
			<input type="hidden" name="csrf_token" value="{$csrf_token}">
			<div class="p20">
				<div>
					<p class="label">Company Name</p>
					<input type="text" name="institution" class="inp" placeholder="Acme Inc.">
				</div>
			...
			<div class="p20 mb40">
				...
				<div class="mt10">
					...
					<label class="label" for="currently_attending">I am currently employed here</label>
				</div>
				<div class="g g2 gg20 mt10">
					<div>
						<p class="label">Month</p>
